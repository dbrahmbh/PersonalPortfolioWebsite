export const Bio = {
  ...
  export const experiences = [
    {
      ...
      desc: "Programmed Python scripts that interact with the Google Ads and YouTube APIs to automate small to mid-sized firms’ online marketing for an e-commerce start-up!",
      skills: [
        "Python",
        "Google Ads API",
        "YouTube API",
    ...
    },
    {
      ...
      date: "June 2023 - August 2023",
      desc: "Developed some new updates for the Wail of a Tale website to help spread the message the wonderful people at Wail of a Tale have to tell!",
      skills: [
        "Golang",
        "Hugo",
        "HTML",
  ...
  export const education = [
    ...
    },
    {
      ...
      date: "August 2016 - May 2020",
      // grade: "88.2%",
      desc: "I completed my high school education at New Albany High School. Here, I took part in many clubs and organizations, such as the National Honors Society and the school's Java coding team. Honors awarded: AP Scholar.",
